...
display.plot(ax=ax1, color="red", label="No_Normarlization_and_no_PCA");
...
tree=plot_tree(best_forest.estimators_[0], 
...
plt.barh(cols[sort], best_forest.feature_importances_[sort])
