...
normalize = [([col], RobustScaler()) for col in cols_normalize]
...
display.plot(ax=ax1, color="red", label="Robust_Normalization_and_No_PCA");


ax=plt.gca()
col_labels=['AUC','AUC CI (95%)']
row_labels=['Robust Normalization and No PCA']
